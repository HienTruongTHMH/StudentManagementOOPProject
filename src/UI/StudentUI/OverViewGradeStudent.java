...
public class OverViewGradeStudent extends javax.swing.JPanel {
    ...
    // Thêm dữ liệu mẫu
    private void loadStudentData(int maSV) {
        try {
            Connection con = DatabaseConnection.getInstance().getConnection();

            // Lấy dữ liệu từ bảng TongKetQuaHT
            String querySummary = "SELECT * FROM TongKetQuaHT WHERE MaSV = ?";
            ...
            // Lấy dữ liệu từ bảng Diem
            String queryDetails = "SELECT * FROM Diem WHERE MaSV = ?";
            ...
            while (rsDetails.next()) {
                model2.addRow(new Object[]{
                    ...
                    rsDetails.getDouble("DiemCC"),
                    rsDetails.getDouble("DiemBT"),
                    rsDetails.getDouble("DiemCH"),
                    rsDetails.getDouble("DiemDA"),
                    rsDetails.getDouble("DiemGK"),
                    rsDetails.getDouble("DiemCK"),
                    rsDetails.getDouble("DiemT10"),
                    rsDetails.getString("DiemChu"),
                    rsDetails.getBoolean("KiemTra")
                });
            }
    ...
    private void updateTableData(int maHocKy, int maNamHoc) {
        ...
        try {
            ...
            String queryDetails = "SELECT * FROM Diem WHERE MaSV = ? AND MaHocKy = ? AND MaNamHoc = ?";
            PreparedStatement psDetails = con.prepareStatement(queryDetails);
            psDetails.setInt(1, maSV);
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã học phần", "Tên học phần", "Số tín chỉ", "Điểm CC", "Điểm BT", "Điểm CH", "Điểm DA", "Điểm CK", "Điểm T10", "Điểm Chữ", "Kiểm tra"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.String.class, java.lang.String.class, java.lang.Integer.class, java.lang.Float.class, java.lang.Float.class, java.lang.Float.class, java.lang.Float.class, java.lang.Float.class, java.lang.Float.class, java.lang.String.class, java.lang.Boolean.class
            };
