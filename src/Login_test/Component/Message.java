...
public class Message extends javax.swing.JPanel {
    ...
    public void showMessage(MessageType messageType, String message) {
        ...
        if (messageType == MessageType.SUCCESS) {
            lbMessage.setIcon(new ImageIcon(getClass().getResource("/Login_test/icon/error.png")));
        } else {
            lbMessage.setIcon(new ImageIcon(getClass().getResource("/Login_test/icon/success.png")));
        }
    }
